...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query("""
        ...
        WHERE c.parentComment IS NULL
          ...
          AND c.lesson.section.course.id = :courseId
        """)
    Page<Comment> findRootCommentsByCourseId(Long courseId, Pageable pageable);
    ...
    @Query("""
        ...
        WHERE c.parentComment IS NULL
          AND c.deletedOn IS NULL
          AND c.lesson.section.course.author.email = :teacherEmail
        """)
    Page<Comment> findRootCommentsByTeacherEmail(String teacherEmail, Pageable pageable);
